...
module.exports = {
  name: "grole",
  description: "إضافة عضو لقروب (بالاسم أو آيدي الكاتجوري).",
  ...
  run: async (client, message, args) => {
    ...
    if (target.roles.cache.has(role.id)) return message.reply("هذا العضو عضو بالفعل في القروب.");
      ...
      return message.channel.send({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`✅ تمت إضافة <@${target.id}> إلى القروب **${groupInfo.name}**.`),
        ],
      });
    } catch (e) {
